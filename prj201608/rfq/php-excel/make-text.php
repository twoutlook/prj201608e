...
$debug003 = fopen("results/$stamp.txt", "w") or die("Unable to open file!");
fwrite($debug003, $data);
fclose($debug003);
...
$defaultOutputFileTxt = pathinfo(__FILE__, PATHINFO_DIRNAME) . DIRECTORY_SEPARATOR . "results" . DIRECTORY_SEPARATOR . "RFQ$stamp.txt";

$make_txt = fopen("results/s$stamp.txt", "w") or die("Unable to open file!");
fwrite($make_txt, $data);
fclose($make_txt);
